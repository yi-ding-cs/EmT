...
from datasets.THU_EP import THU
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='THU')
    parser.add_argument('--data-path', type=str, default="D:\\DingYi\\Dataset\\THU")    # change this accordingly
    ...
    parser.add_argument('--sub-segment', type=int, default=2, help = "Window length of each time sequence")
    ...
    cv.leave_n_sub_out(n=8, subject=sub_to_run, shuffle=False, reproduce=args.reproduce)